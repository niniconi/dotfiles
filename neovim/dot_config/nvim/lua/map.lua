...
keyset('n', '<leader>y', function() Snacks.terminal.toggle() end, opts.default("Toggle terminal"))
...
keyset('n', '<leader>B', ':lua require("dap").set_breakpoint(vim.fn.input("Breakpoint condition: "))<CR>', opts.default("Conditional breakpoint"))
keyset('n', '<leader>lp', ':lua require("dap").set_breakpoint(nil, nil, vim.fn.input("Log point message: "))<CR>', opts.default("Log point"))
...
keyset('n', '<leader>wl', '<cmd>lua print(vim.inspect(vim.lsp.buf.list_workspace_folders()))<CR>', opts.default("List workspaces"))
