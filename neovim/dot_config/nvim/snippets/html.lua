...
<meta name="{}" content="{}">
  ...
  s({ trig = "metau", dscr = "Meta tag (UTF-8)" }, t('<meta charset="UTF-8">')),

  s(
    { trig = "metav", dscr = "Meta tag (viewport)" },
    t('<meta name="viewport" content="width=device-width, initial-scale=1.0">')
  ),

  s(
    { trig = "link", dscr = "Link tag (stylesheet)" },
    fmt(
      [[
<link rel="stylesheet" href="{}">
  ...
  s(
    { trig = "linkfavicon", dscr = "Link tag (favicon)" },
    fmt(
      [[
...
<title>{}</title>
  ...
  s(
    { trig = "script", dscr = "Script tag (external)" },
    fmt(
      [[
<script src="{}.js"></script>
  ...
  s(
    { trig = "scripti", dscr = "Script tag (inline)" },
    fmt(
      [[
<script>
    {}
...
<base href="{}" target="{}">
  ...
  s(
    { trig = "header", dscr = "Header element" },
    fmt(
      [[
<header>
    {}
  ...
  s(
    { trig = "nav", dscr = "Navigation element" },
    fmt(
      [[
<nav>
    {}
  ...
  s(
    { trig = "main", dscr = "Main content element" },
    fmt(
      [[
<main>
    {}
  ...
  s(
    { trig = "section", dscr = "Section element" },
    fmt(
      [[
<section>
    {}
  ...
  s(
    { trig = "article", dscr = "Article element" },
    fmt(
      [[
<article>
    {}
...
<aside>
  ...
  s(
    { trig = "footer", dscr = "Footer element" },
    fmt(
      [[
<footer>
    {}
  ...
  s(
    { trig = "details", dscr = "Details/Summary element" },
    fmt(
      [[
<details>
    <summary>{}</summary>
  ...
  s(
    { trig = "dialog", dscr = "Dialog element" },
    fmt(
      [[
<dialog>
    {}
  ...
  s(
    { trig = "figure", dscr = "Figure with figcaption" },
    fmt(
      [[
<figure>
    {}
...
<img src="{}" alt="{}">
  ...
  s(
    { trig = "picture", dscr = "Picture element" },
    fmt(
      [[
<picture>
  ...
  s({ trig = "br", dscr = "Line break" }, t("<br>")),

  s({ trig = "hr", dscr = "Horizontal rule" }, t("<hr>")),

  s(
    { trig = "blockquote", dscr = "Blockquote" },
    fmt(
      [[
<blockquote>
    {}
  ...
  s(
    { trig = "pre", dscr = "Preformatted text" },
    fmt(
      [[
<pre>
{}
...
<code>{}</code>
  ...
  s(
    { trig = "strong", dscr = "Strong emphasis" },
    fmt(
      [[
<strong>{}</strong>
]],
...
<input type="email" name="{}" id="{}" placeholder="{}">
  ...
  s(
    { trig = "inputp", dscr = "Input password" },
    fmt(
      [[
...
<input type="number" name="{}" id="{}" min="{}" max="{}">
  ...
  s(
    { trig = "inputc", dscr = "Input checkbox" },
    fmt(
      [[
...
<label for="{}">{}</label>
  ...
  s(
    { trig = "select", dscr = "Select dropdown" },
    fmt(
      [[
<select name="{}" id="{}">
    <option value="{}">{}</option>
  ...
  s(
    { trig = "optgroup", dscr = "Option group" },
    fmt(
      [[
<optgroup label="{}">
    <option value="{}">{}</option>
...
<textarea name="{}" id="{}" rows="{}" placeholder="{}">{}</textarea>
  ...
  s(
    { trig = "button", dscr = "Button element" },
    fmt(
      [[
<button type="{}">{}</button>
]],
...
<input type="date" name="{}" id="{}">
  ...
  s(
    { trig = "fieldset", dscr = "Fieldset with legend" },
    fmt(
      [[
<fieldset>
    <legend>{}</legend>
  ...
  s(
    { trig = "output", dscr = "Output element" },
    fmt(
      [[
...
<meter value="{}" min="{}" max="{}">{}</meter>
  ...
  s(
    { trig = "progress", dscr = "Progress element" },
    fmt(
      [[
...
<tr>
  ...
  s(
    { trig = "th", dscr = "Table header cell" },
    fmt(
      [[
<th scope="{}">{}</th>
]],
...
<td>{}</td>
  ...
  s(
    { trig = "caption", dscr = "Table caption" },
    fmt(
      [[
<caption>{}</caption>
]],
  ...
  s(
    { trig = "colgroup", dscr = "Column group" },
    fmt(
      [[
<colgroup>
    <col span="{}">
...
<source src="{}" type="{}">
  ...
  s(
    { trig = "track", dscr = "Track element (subtitles)" },
    fmt(
      [[
<track kind="{}" src="{}" srclang="{}" label="{}">
  ...
  s(
    { trig = "iframe", dscr = "Iframe element" },
    fmt(
      [[
<iframe src="{}" title="{}" width="{}" height="{}" frameborder="{}">{}</iframe>
  ...
  s(
    { trig = "canvas", dscr = "Canvas element" },
    fmt(
      [[
...
<svg width="{}" height="{}" viewBox="0 0 {} {}" xmlns="http://www.w3.org/2000/svg">
  ...
  s(
    { trig = "scriptsrc", dscr = "Script with src" },
    fmt(
      [[
<script src="{}"{}></script>
]],
  ...
  s(
    { trig = "scriptdefer", dscr = "Script with defer" },
    fmt(
      [[
<script src="{}" defer></script>
  ...
  s(
    { trig = "scriptasync", dscr = "Script with async" },
    fmt(
      [[
<script src="{}" async></script>
  ...
  s(
    { trig = "noscript", dscr = "Noscript element" },
    fmt(
      [[
<noscript>
    {}
  ...
  s(
    { trig = "template", dscr = "Template element" },
    fmt(
      [[
<template id="{}">
    {}
...
<embed src="{}" type="{}" width="{}" height="{}">
  ...
  s(
    { trig = "object", dscr = "Object element" },
    fmt(
      [[
...
<script src="{}.js"></script>
  ...
  s(
    { trig = "favicon", dscr = "Favicon link" },
    fmt(
      [[
<link rel="icon" href="{}" type="image/{}">
  ...
  s(
    { trig = "apple-touch-icon", dscr = "Apple touch icon" },
    fmt(
      [[
<link rel="apple-touch-icon" sizes="{}" href="{}">
  ...
  s(
    { trig = "viewport", dscr = "Viewport meta tag" },
    t('<meta name="viewport" content="width=device-width, initial-scale=1.0">')
  ),

  s({ trig = "charset", dscr = "Charset meta tag" }, t('<meta charset="UTF-8">')),

  s(
    { trig = "desc", dscr = "Description meta tag" },
    fmt(
      [[
<meta name="description" content="{}">
  ...
  s(
    { trig = "og", dscr = "Open Graph meta tag" },
    fmt(
      [[
<meta property="og:{}" content="{}">
  ...
  s(
    { trig = "tw", dscr = "Twitter card meta tag" },
    fmt(
      [[
<meta name="twitter:{}" content="{}">
  ...
  s(
    { trig = "robots", dscr = "Robots meta tag" },
    fmt(
      [[
<meta name="robots" content="{}">
  ...
  s(
    { trig = "icon", dscr = "Favicon link (short)" },
    fmt(
      [[
<link rel="icon" href="{}">
]],
...
<data value="{}">{}</data>
  ...
  s(
    { trig = "ruby", dscr = "Ruby annotation" },
    fmt(
      [[
<ruby>
    {}<rt>{}</rt>
  ...
  s(
    { trig = "bdo", dscr = "Bidirectional override" },
    fmt(
      [[
<bdo dir="{}">{}</bdo>
]],
